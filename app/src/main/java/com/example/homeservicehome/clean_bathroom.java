...
public class clean_bathroom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvLabel = findViewById(R.id.bathroomcleaningheading);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DBHelper helper = new DBHelper(clean_bathroom.this, DBHelper.DBNAME, null, 1);
                ...
                if (status >= 0) {
                    Toast.makeText(clean_bathroom.this, "Added To Cart", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(clean_bathroom.this,Cleaning_dashboard.class);
                    startActivity(intent);
                    finish();
                }
                else
                    Toast.makeText(clean_bathroom.this, "Error", Toast.LENGTH_LONG).show();
            }
        });
