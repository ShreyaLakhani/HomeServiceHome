...
public class clean_kitchen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvLabel = findViewById(R.id.kitchencleaningheading);
        ...
        kadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DBHelper helper = new DBHelper(clean_kitchen.this, DBHelper.DBNAME, null, 1);
                ...
                if (status >= 0) {
                    Toast.makeText(clean_kitchen.this, "Added To Cart", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(clean_kitchen.this,Cleaning_dashboard.class);
                    startActivity(intent);
                }
                else
                    Toast.makeText(clean_kitchen.this, "Error", Toast.LENGTH_LONG).show();
            }
        });
