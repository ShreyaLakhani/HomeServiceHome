...
public class clean_balcony extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvLabel = findViewById(R.id.balconycleaningheading);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DBHelper helper = new DBHelper(clean_balcony.this, DBHelper.DBNAME, null, 1);
                ...
                if (status >= 0) {
                    Toast.makeText(clean_balcony.this, "Added To Cart", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(clean_balcony.this,Cleaning_dashboard.class);
                    startActivity(intent);
                    finish();
                }
                else
                    Toast.makeText(clean_balcony.this, "Error", Toast.LENGTH_LONG).show();
            }
        });
